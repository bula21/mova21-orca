...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_collection, item_wrapper_class: 'form-check position-relative', item_label_class: 'form-check-label', tag: 'fieldset', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
    end
    b.use :input, class: 'form-check-input position-absolute', error_class: 'is-invalid', valid_class: 'is-valid'
  ...
  config.wrappers :inline_date, tag: 'div', class: 'form-group', error_class: 'is-invalid', valid_class: 'is-valid' do |b|
    b.use :html5
    b.use :label, class: 'control-label'
    b.wrapper tag: 'div', class: 'd-flex' do |ba|
      ba.use :input, item_wrapper_tag: 'p', class: 'form-select me-2 w-auto', wrap_with: { class: 'd-flex' }
