...
class TransportLocationsController < ApplicationController
  ...
  def create
    ...
    if @transport_location.save
      redirect_to transport_locations_path, notice: 'Transport location was successfully created.'
    else
      render :new
    end
  end
  ...
  def update
    if @transport_location.update(transport_location_params)
      redirect_to transport_locations_path, notice: 'Transport location was successfully updated.'
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to transport_locations_url, notice: 'Transport location was successfully destroyed.'
  end
